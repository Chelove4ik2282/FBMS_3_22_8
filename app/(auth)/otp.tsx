...
import { useRouter, useLocalSearchParams as useSearchParams } from 'expo-router';
        ...
        <View className="flex-1 justify-between pt-24 px-6 pb-6"> 
          <View>
            ...
            <Text className="text-center text-sm text-[#5D6481] mb-6">
              ...
              <Text className="mb-6 font-medium text-[#0057ff]">{email}</Text>
            </Text>
          ...
          <View>
            ...
            <View className="flex-row justify-between mb-">
              <TouchableOpacity
                onPress={handleBack}
